...
<tr><td align="right">Servidor LAN:</td><td><span id="x_serverlan"></span></td></tr>
<tr><td align="right">Puerto LAN:</td><td><span id="x_portlan"></span></td></tr>
<tr><td align="right">Servidor WAN:</td><td><span id="x_serverwan"></span></td></tr>
<tr><td align="right">Puerto WAN:</td><td><span id="x_portwan"></span></td></tr>
...
void send_information_values_html(){
  ...
  values += "x_serverlan|" +  (String)config.serverMQTTLAN +  "|div\n";
  values += "x_portlan|" +  (String)config.puertoMQTTLAN +  "|div\n";
  values += "x_serverwan|" +  (String)config.serverMQTTWAN +  "|div\n";
  values += "x_portwan|" +  (String)config.puertoMQTTWAN +  "|div\n";
